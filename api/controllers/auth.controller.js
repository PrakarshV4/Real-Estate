...
export const google =  async(req, res, next) => {
    try{
        ...
        //if user exists create a token and send it in cookies
        if(user){
            ...
            //since user does not exist in the db create a new user with generated password then send token and cookie
            //generate pass as in schema we defined that we will receive a password
