        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-4 '>
                ...
                <div className='flex gap-4'>
                    <input disabled={uploading} onChange={(e)=>{setFiles(e.target.files)}} className='p-3 w-full border border-gray-300 rounded ' type="file" id='images' accept='image/*' multiple />
